...
# Для Timeweb (РФ) оставьте ["hh", "telegram"]: rabota/habr по желанию,
# а LinkedIn с российского хостинга недоступен и его покрывает внешний
# сборщик, публикующий vacancies.json в GitHub.
# Возможные значения: "hh", "rabota", "habr", "linkedin", "company", "telegram"
# ---------------------------------------------------------------------------
ENABLED_SOURCES = ["hh", "telegram"]
